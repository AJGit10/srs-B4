            ...
            <span class="text">
                <h3>
                    <table class='table'>
                        ...
                        <tbody>
                        <?php
							$sql = "SELECT apartment.aptId, apartment.aptName, notes.noteId, notes.noteTitle, notes.noteDetails FROM apartment JOIN notes ON apartment.aptId = notes.noteId WHERE apartment.aptId"; 
