                ...
                <h3>
                    <table class='table'>
                        ...
                        <tbody>
                            ...
                            <?php
                            $sqljoin = "SELECT user.userId, user.firstName, user.lastName, user.eMail, user.aptId, role.roleLabel FROM user JOIN role ON user.rollId = role.rollId WHERE aptId = '$idOfChairPerson'"; 
                            ...
                            <?php } else { ?>
                                ...
                                while ($row3 = $result->fetch_assoc()) {
                                    ...
                                    <td><a href="../chairmen/updateUserByCp.php?id=<?= $row3['userId'] ?> "><button
